...
function filtrarAuto() { // Funcion del ato nivel (que consume otra funcion como parametro)
...
function noResultados() {
    ...
    noResultados.textContent = 'No se encontraron autos con esas caracteristicas';
